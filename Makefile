...
ACLOCAL = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run aclocal-1.10
ALLOCA = 
ALLOCA_H = alloca.h
AMTAR = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run tar
AUTOCONF = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run automake-1.10
AUXDIR = build-aux
AWK = gawk
BITSIZEOF_PTRDIFF_T = 
...
MAKEINFO = ${SHELL} /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = GNU findutils 4.4.2
...
YACC = bison -y
YFLAGS = 
abs_builddir = /home/r2d2/Devel/gnu/findutils-4.4.2
abs_srcdir = /home/r2d2/Devel/gnu/findutils-4.4.2
abs_top_builddir = /home/r2d2/Devel/gnu/findutils-4.4.2
abs_top_srcdir = /home/r2d2/Devel/gnu/findutils-4.4.2
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
dvidir = ${docdir}
exec_prefix = ${prefix}
gl_LIBOBJS =  argmatch.o basename.o canonicalize.o chdir-long.o close-stream.o closein.o closeout.o creat-safer.o cycle-check.o dirname.o dup-safer.o exitfail.o fd-safer.o filemode.o filenamecat.o fopen-safer.o fstatat.o fts.o gettime.o hash.o human.o i-ring.o idcache.o modechange.o mountlist.o open-safer.o openat-proc.o pipe-safer.o quote.o quotearg.o regex.o same.o save-cwd.o savedir.o strftime.o stripslash.o xgetcwd.o xmalloc.o xstrtod.o xstrtol.o xstrtol-error.o xstrtoul.o yesno.o
gl_LTLIBOBJS =  argmatch.lo basename.lo canonicalize.lo chdir-long.lo close-stream.lo closein.lo closeout.lo creat-safer.lo cycle-check.lo dirname.lo dup-safer.lo exitfail.lo fd-safer.lo filemode.lo filenamecat.lo fopen-safer.lo fstatat.lo fts.lo gettime.lo hash.lo human.lo i-ring.lo idcache.lo modechange.lo mountlist.lo open-safer.lo openat-proc.lo pipe-safer.lo quote.lo quotearg.lo regex.lo same.lo save-cwd.lo savedir.lo strftime.lo stripslash.lo xgetcwd.lo xmalloc.lo xstrtod.lo xstrtol.lo xstrtol-error.lo xstrtoul.lo yesno.lo
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
...
install_sh = $(SHELL) /home/r2d2/Devel/gnu/findutils-4.4.2/build-aux/install-sh
